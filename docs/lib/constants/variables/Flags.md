...
[style-escape-codes](../../../modules.md) / [lib/constants](../README.md) / Flags
...
> `readonly` **d**: readonly [`2`, `22`] = `Style.dim`
...
> `readonly` **ud**: readonly [`21`, `24`] = `Style.underlineDouble`
...
[lib/constants.ts:137](https://github.com/mastermind-0xff/style-escape-codes/blob/86f72e47c8a4169fb2601208e7c23c504221a7fb/src/lib/constants.ts#L137)
